...
async def place_bet(
    ...
    try:
        ...
        # Round UP to ensure shares * price >= net_amount (meets $1 minimum)
        # Round to 2 decimal places as required by Polymarket
        import math
        shares_raw = net_amount / price
        shares = math.ceil(shares_raw * 100) / 100  # Round up to 2 decimals
        
        # Verify the order cost meets minimum
        order_cost = round(shares * price, 6)
