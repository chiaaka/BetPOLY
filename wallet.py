...
3-step flow matching polymarket.com:
...
# =============================================================================
# Builder config — exact pattern from official Polymarket SDK
# https://github.com/Polymarket/py-builder-signing-sdk
# https://github.com/tosmart01/poly-web3
# =============================================================================
...
def _build_approval_txs():
    """Build 7 approval transactions using SafeTransaction model."""
    ...
    for spender in [CTF, CTF_EXCHANGE, NEG_RISK_EXCHANGE, NEG_RISK_ADAPTER]:
        txs.append(SafeTransaction(to=USDC_E, data=_encode_approve(spender), value=0, operation=0))
    for op in [CTF_EXCHANGE, NEG_RISK_EXCHANGE, NEG_RISK_ADAPTER]:
        txs.append(SafeTransaction(to=CTF, data=_encode_set_approval_for_all(op), value=0, operation=0))
    return txs
