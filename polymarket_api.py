...
def parse_event(event: dict) -> dict:
    ...
    for mkt in markets:
        ...
        # ==============================================
        if q.startswith("will ") and "win" in q and outcomes == ["Yes", "No"] or \
           (len(outcomes) == 2 and outcome_names == ["yes", "no"] and "win" in q):
