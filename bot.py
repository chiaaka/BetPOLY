    ...
    # --- Wallet ---
        ...
        if user:
            ...
            if bridge and bridge.get("evm"):
                ...
                await q.edit_message_text(
                    ...
                    f"   <b>BSC</b> — BNB, USDC, USDT, BUSD\n"
                    f"   <b>Base</b> — ETH, USDC, USDT\n"
                    f"   <b>Arbitrum</b> — ETH, USDC, USDT, ARB\n"
                    f"   <b>Optimism</b> — ETH, USDC, OP\n"
                    f"   <b>Polygon</b> — USDC, USDC.e, POL\n"
                    f"   <b>Ethereum</b> — ETH, USDC, USDT"
                    ...
                    "⚠️ <b>MINIMUM DEPOSITS:</b>\n"
                    "   L2s (BSC, Base, Arb, OP, Polygon): <b>$2</b>\n"
                    "   Ethereum: <b>$7</b>\n"
                    "   Bitcoin / Tron: <b>$9</b>\n"
                    "   ⛔ Below minimum = funds NOT processed\n\n"
                ...
                # Fallback: show Safe address on Polygon only
                await q.edit_message_text(
                    "🔗 <b>Send Crypto</b>\n\n"
        ...
        if user:
            ...
            await q.edit_message_text(
                ...
                f"<code>{deposit_addr}</code>\n\n"
                f"━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                f"✅ Send <b>USDC.e (Bridged USDC)</b> on Polygon\n"
                f"   Ready to bet immediately.\n\n"
                f"⚠️ <b>Native USDC ≠ USDC.e</b>\n"
                f"Most exchanges send native USDC, which\n"
                f"<b>won't work</b> for betting directly.\n\n"
                f"👉 <b>Recommended:</b> Use \"Send Crypto (Any Chain)\"\n"
                f"instead — it auto-converts ANY token on\n"
                f"ANY chain to USDC.e. Much easier!\n\n"
                f"💰 Min bet: $1",
                parse_mode=ParseMode.HTML,
                reply_markup=Markup([
                    [Btn("🔗 Send from Any Chain (recommended)", callback_data="deposit_bridge")],
