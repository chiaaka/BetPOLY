...
async def on_button(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # --- Wallet ---
        ...
        logger.info(f"w_deposit: user={user is not None}, user_id={q.from_user.id}")
        if user:
            ...
            await q.edit_message_text(
                ...
                parse_mode=ParseMode.HTML, reply_markup=Markup([
                    [Btn("📋 Copy Address", callback_data="copy_deposit_addr")],
                    [Btn("🔙 Back to Wallet", callback_data="wallet_menu")]
                ])
            )
