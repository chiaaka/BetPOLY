...
def kb_main():
    return Markup([
        ...
        [Btn("🥊 UFC/MMA", callback_data="league_ufc"),
...
def kb_soccer():
    ...
    return Markup([
        ...
        [Btn("🇪🇸 La Liga", callback_data="league_laliga"),
         Btn("🇮🇹 Serie A", callback_data="league_sea")],
        [Btn("🇩🇪 Bundesliga", callback_data="league_bundesliga"),
         Btn("🇫🇷 Ligue 1", callback_data="league_ligue-1")],
        # Cups
